...
<div class="max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl sm:text-2xl font-bold">Tambah User Baru</h1>
    </div>
    ...
    <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
        ...
        <ul class="list-disc list-inside space-y-1 text-xs">
            <li>User baru akan dimulai dengan saldo Rp 0 dan 0 poin</li>
            <li>Password harus minimal 6 karakter</li>
            <li>Email harus unik dan belum terdaftar</li>
            <li>Role "User" hanya dapat melihat data sendiri</li>
        </ul>
    </div>
</div>
@endsection
